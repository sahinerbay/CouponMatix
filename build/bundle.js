...
/******/ 	var hotCurrentHash = "0eaf7d24c6bfb922e088"; // eslint-disable-line no-unused-vars
...
var dom = function () {
    ...
    var createElementWithClassName = function createElementWithClassName(el, className) {
        var element = document.createElement(el);
        element.className = className;
        return element;
    };

    var setTextContent = function setTextContent(el, txt) {
        var index = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;

        var foundElement = document.querySelectorAll('.' + el);
        foundElement[index].textContent = txt;
    };

    var setAttributes = function setAttributes(el, attrsObject) {
    ...
    var getOffers = function getOffers(url) {
    ...
    var handleScroll = function handleScroll() {
        ...
        var filterBar = dom.getElement('content__galery__info__filter');
    ...
    var createContentGaleryOffer = function createContentGaleryOffer(contentGaleryContainer, offer) {
        var i = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
        var offerClassname = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'search';

        // CREATE ROW AND APPEND INTO CONTENT-GALERY //
        var contentGaleryOffer = dom.createElementWithClassName('div', 'content__galery__offer content__galery__offer--side  content__galery__offer--padding row__xs-12 row__s-6 row__md-4 row__lg-3');
        dom.append(contentGaleryContainer, contentGaleryOffer);

        // GENERATE TOP PART (IMAGE & ITS FRAME) OF EACH OFFER // 
        var contentGaleryOfferTop = dom.createElementWithClassName('div', 'content__galery__offer__top content__galery__offer__top--margin-bottom'),
        ...
        var contentGaleryOfferFooter = dom.createElementWithClassName('div', 'content__galery__offer__footer'),
...
var _filterbar = __webpack_require__(91);
...
var _ads = __webpack_require__(335);
...
var createContent = function () {
    ...
    var wrapper = _dom2.default.createElementWithClassName('div', 'wrapper wrapper--margin'),
        contentEl = _dom2.default.createElementWithClassName('div', 'content content--margin-top content--padding-top');

    // INSERT WRAPPER AND ITS ONLY CHILD CONTENT ELEMENT INTO DOM //
    _dom2.default.append(document.body, wrapper);
    _dom2.default.append(wrapper, contentEl);

    // RETRIEVE CONTENT ELEMENT TO BE FILLED BELOW //
    var content = document.querySelector('.content');

    var offerDetailsGlobal = void 0;

    // GENERATE 3 X ADS FOR MAIN PAGE ONLY //
    var ads = function ads() {
        var contentAd = _dom2.default.createElementWithClassName('div', 'content__ad row');
        _dom2.default.append(content, contentAd);

        for (var numberOfAdSlot = 0; numberOfAdSlot < 3; numberOfAdSlot++) {

            var randNo = Math.floor(Math.random() * _ads2.default.medium.length);

            var contentAdFrame = _dom2.default.createElementWithClassName('div', 'content__ad__frame row__xs-12 row__s-6 row__md-4 row__lg-4'),
                contentAdFrameImage = _dom2.default.createElementWithClassName('img', 'content__ad__frame--image'),
                contentAdFrameImageLink = _dom2.default.createElementWithClassName('a', 'content__ad__frame--image__link');

            // SET URL LINK INTO IMAGE //
            contentAdFrameImageLink.href = _ads2.default.medium[randNo].linkUrl;
            contentAdFrameImageLink.setAttribute('target', '_blank');
            contentAdFrameImageLink.setAttribute('title', _ads2.default.medium[randNo].alt);
            contentAdFrameImage.src = _ads2.default.medium[randNo].imgUrl;
            contentAdFrameImage.alt = _ads2.default.medium[randNo].alt;

            _dom2.default.append(contentAd, contentAdFrame);
            _dom2.default.append(contentAdFrame, contentAdFrameImageLink);
            _dom2.default.append(contentAdFrameImageLink, contentAdFrameImage);
        }
    };
    ...
    var sideAd = function sideAd() {
        ...
        var randNo = Math.floor(Math.random() * _ads2.default.large.length);

        var contentAdFrame = _dom2.default.createElementWithClassName('div', 'content__ad__frame content__ad__frame--margin-bottom row__xs-12'),
            contentAdFrameImage = _dom2.default.createElementWithClassName('img', 'content__ad__frame--image'),
            contentAdFrameImageLink = _dom2.default.createElementWithClassName('a', 'content__ad__frame--image__link');

        // SET URL LINK INTO IMAGE //
        contentAdFrameImageLink.href = _ads2.default.large[randNo].linkUrl;
        contentAdFrameImageLink.setAttribute('target', '_blank');
        contentAdFrameImageLink.setAttribute('title', _ads2.default.large[randNo].alt);

        contentAdFrameImage.src = _ads2.default.large[randNo].imgUrl;
        contentAdFrameImage.alt = _ads2.default.large[randNo].alt;
    ...
    var galeryInfo = function galeryInfo(offer, isMainPage) {
        ...
        var contentGalery = _dom2.default.createElementWithClassName('div', 'content__galery content__galery--margin-bottom ' + offer.classname + '__galery row'),
            contentGaleryInfo = _dom2.default.createElementWithClassName('div', 'content__galery__info row__lg-12'),
            h2 = _dom2.default.createElementWithClassName('h2', 'content__galery__info__title content__galery__info__title--box-shadow ' + offer.classname + '__title'),
            para = _dom2.default.createElementWithClassName('p', 'content__galery__info__description ' + offer.classname + '__description');

        // INSERT INFO & DESCRIPTION SECTION INTO CONTENT //
        _dom2.default.append(content, contentGalery);
        _dom2.default.append(contentGalery, contentGaleryInfo);
        _dom2.default.append(contentGaleryInfo, h2, para);

        // PLACE CONTENT (TITLE & DESCRIPTION) INTO H2 AND PARAGRAPH VIA JSON //
        _dom2.default.setTextContent(offer.classname + '__title', offer.main);
        _dom2.default.setTextContent(offer.classname + '__description', offer.desc);

        // IF IT'S NOT MAIN PAGE BUT SECTIONS CREATE FILTER SELECT DROP DOWNS //
        if (!isMainPage) {
            var filterFrame = _dom2.default.createElementWithClassName('div', 'content__galery__info__filter row'),
                filterFrameLeft = _dom2.default.createElementWithClassName('div', 'content__galery__info__filter-left row__xs-3 row__s-6 '),
                filterFrameRight = _dom2.default.createElementWithClassName('div', 'content__galery__info__filter-right row__xs-9 row__s-6');

            _dom2.default.append(contentGaleryInfo, filterFrame);
            _dom2.default.append(filterFrame, filterFrameLeft, filterFrameRight);

            // SET FILTER-SELECT BAR STICKY ONSCROLL //
            window.addEventListener('scroll', _dom2.default.handleScroll);
        }
    };

    // CREATE GALERY OF COUPONS / SAMPLES / GIVEAWAYS //
    // 'OFFER' PARAMETER IS A RESPONSE 'ITEMS' OF JSON REQUEST //
    var galery = function galery(offer, isMainPage) {

        // RETRIEVE CLASSNAME OF EACH TYPE (COUPONS, SAMPLES, GIVEAWAYS) //
        var offerClassname = offer[0].classname;

        // USE THE RETRIEVED CLASSNAME IN ORDER TO RETRIEVE DEDICATED CONTENT GALERY TO EACH SECTION //
        var contentGalery = _dom2.default.getElement(offerClassname + '__galery');

        // CREATE CONTENT--GALERY--CONTAINER //
        var contentGaleryContainer = _dom2.default.createElementWithClassName('div', 'content__galery__container');
        _dom2.default.append(contentGalery, contentGaleryContainer);

        // LOOP THROUGH RESPONSE OBJECT (WHICH IS ARRAY NOW, AFTER PARSED FROM JSON) //
        for (var i = 0; i < offer.length; i++) {
            _dom2.default.createContentGaleryOffer(contentGaleryContainer, offer[i], i, offerClassname);
        } //END OF LOOP//
        ...
        if (isMainPage) {
            ...
            var contentGaleryOffer = document.querySelectorAll('.content__galery__offer');
            for (var _i = 0; _i < contentGaleryOffer.length; _i++) {
                contentGaleryOffer[_i].className = 'content__galery__offer content__galery__offer--main content__galery__offer--padding row__xs-12 row__s-6 row__md-4 row__lg-3';
            }

            // GENERATE VIEW LINK ELEMENT WITH CLASSNAMES //
            var contentGaleryViewAllContainer = _dom2.default.createElementWithClassName('div', 'content__galery__viewAll content__galery__viewAll--margin-top'),
                contentGaleryViewAllLink = _dom2.default.createElementWithClassName('a', 'content__galery__viewAll--link ' + offerClassname + '--link');

            // SET ATTRIBUTES OF VIEW LINK ELEMENT //
            var contentGaleryViewAllLinkAttribute = {
                "href": '#' + offerClassname
            };
            _dom2.default.setAttributes(contentGaleryViewAllLink, contentGaleryViewAllLinkAttribute);

            // APPEND VIEW LINK INTO CONTENT-GALERY (AS ITS LAST CHILD)
            _dom2.default.append(contentGalery, contentGaleryViewAllContainer);
            _dom2.default.append(contentGaleryViewAllContainer, contentGaleryViewAllLink);
            ...
            _dom2.default.setTextContent(offerClassname + '--link', "View All");
            var viewLinkButton = document.querySelector('.' + offerClassname + '--link');
    ...
    var createContentSidePage = function createContentSidePage(type) {

        // SCROLL ALL THE WAY UP WHEN THE CONTENT LOADS //
        window.scrollTo(0, 0);

        // GENERATE ADDRESS TO ACQUIRE OFFER INFO & DESCRIPTION 
        var url = 'https://couponmatix.firebaseio.com/v0/types/' + type + '.json';

        _dom2.default.getOffers(url).then(function (result) {
            ...
            if (footerEl !== null) {
                _dom2.default.removeElement(footerEl);
            }

            // EMPTY CONTENT ELEMENT //
            var content = _dom2.default.getElement('content');
            _dom2.default.removeAllChildren(content);
            ...
            _filterbar2.default.select(type);
            _filterbar2.default.sort();

            // RETURN NEW PROMISE TO ACQUIRE OFFER STATEMENT, IMAGE & LINK URL //
            return _dom2.default.getOffers('https://couponmatix.firebaseio.com/v0/items/' + type + '.json');
        }).then(function (result) {

            // PARSE JSON INTO JS OBJECT //
            var offerDetails = JSON.parse(result);
    ...
    var createContentViaFiltering = function createContentViaFiltering(type, filterQuery) {
        ...
        var url = 'https://couponmatix.firebaseio.com/v0/items/' + type + '.json';
        ...
        _dom2.default.getOffers(url).then(function (result) {
            ...
            // EMPTY CONTENT ELEMENT //
            var contentGaleryContainer = _dom2.default.getElement('content__galery__container');
            _dom2.default.removeElement(contentGaleryContainer);

            // CHANGE SORTING SELECTED VALUE TO NEWEST //
            // EVERYTIME YOU SELECT A CATEGORY //
            var selectedNewest = _dom2.default.getElement('filterbar__sort');
            ...
            // WHEN A CATEGORY SELECTED //
                    ...
                    var filteredOfferDetails = offerDetails.filter(function (currentEl) {
                        return currentEl.category == filterQuery;
                    });
    ...
    // ONLY LOADS CONTENT--GALERY--CONTAINER //
    // DOESN'T DEAL WITH OTHER COMPONENTS OF THE PAGE //
    var createContentViaSorting = function createContentViaSorting(sortQuery) {
        ...
        var query = sortQuery.replace(/\s/g, '').toLowerCase();

        switch (query) {
            case 'newest':
                var sortedOffers = sortByDate.ascending(offerDetailsGlobal);
    ...
    var sortByDate = function () {
        ...
        var ascending = function ascending(offers) {
            return offers.sort(function (a, b) {
                return b.addedAs - a.addedAs;
            });
        };

        var descending = function descending(offers) {
            return offers.sort(function (a, b) {
                return a.addedAs - b.addedAs;
            });
        };
    ...
    var createContentMainPage = function createContentMainPage() {
        var url = 'https://couponmatix.firebaseio.com/v0/types.json';

        _dom2.default.getOffers(url).then(function (result) {
            // PARSE JSON INTO JS OBJECT //
            var offer = JSON.parse(result);
            _filterbar2.default.searchbar();
            ...
            var prom = new Promise(function (resolve, reject) {
                for (var prop in offer) {
                    ...
                    _dom2.default.getOffers('https://couponmatix.firebaseio.com/v0/items/' + prop + '.json').then(function (result) {
                        // PARSE JSON INTO JS OBJECT //
                        var offerDetails = JSON.parse(result);

                        // LIMIT HOW MANY OFFERS WILL BE RENDERED ON MAIN PAGE FOR EACH SECTION (COUPONS, SAMPLES, GIVEAWAYS) //
                        var limitedOffers = offerDetails.reverse().slice(0, 4);
    ...
    return {
        ...
        createContentViaFiltering: createContentViaFiltering,
...
var filterBar = function () {
    ...
    var content = function content() {
        ...
        var filterbar = _dom2.default.createElementWithClassName('div', 'filterbar'),
            filterbarContent = _dom2.default.createElementWithClassName('div', 'filterbar--content filterbar--min-height filterbar--align-items');

        filterbarContent.innerHTML = "";

        // INSERT FILTER BAR AND ITS ONLY CHILD INTO HEADER //
        _dom2.default.append(header, filterbar);
        _dom2.default.append(filterbar, filterbarContent);
    };
    ...
    var searchbar = function searchbar() {
        ...
        var filterbarSearch = _dom2.default.createElementWithClassName('input', 'filterbar__searchbar');

        // CHECK PREVIOUSLY CREATED SEARCH BAR ELEMENT //
        var duplicate = _dom2.default.getElement(filterbarSearch.className);
        if (duplicate !== null) {
            _dom2.default.removeElement(duplicate);
        }

        // SET ATTRIBUTES FOR SEARCH BAR //
        var filterSearchAttributes = {
            'type': 'text',
            'name': 'search',
            'placeholder': 'Search For Coupons: Yoplait, Ziploc, Downy, Detergent...'
        };
        _dom2.default.setAttributes(filterbarSearch, filterSearchAttributes);

        // INSERT SEARCH BAR INTO FILTER BAR //        
        var filterbarContent = _dom2.default.getElement('filterbar--content');
        _dom2.default.append(filterbarContent, filterbarSearch);

        // CREATE SEARCH RESULT UL //
        var filterbarSearchResults = _dom2.default.createElementWithClassName('ul', 'filterbar__searchbar__result');

        // INSERT SEARCH RESULT INTO FILTERBAR--CONTENT //
        _dom2.default.append(filterbarContent, filterbarSearchResults);

        var searchbar = _dom2.default.getElement('filterbar__searchbar');

        (0, _search2.default)(searchbar);
    ...
    var select = function select(type) {
        ...
        var filterbarSelect = _dom2.default.createElementWithClassName('select', 'filterbar__select'),
            filterbarSelectTitle = _dom2.default.createElementWithClassName('span', 'filterbar__select--title');

        filterbarSelectTitle.textContent = "Categories:";

        // SET ATTRIBUTES FOR SELECT DROPDOWN //
        var filterSelectAttributes = {
            'name': 'categories'
        };
        _dom2.default.setAttributes(filterbarSelect, filterSelectAttributes);
        ...
        var filterFrameRight = _dom2.default.getElement('content__galery__info__filter-right');
        _dom2.default.append(filterFrameRight, filterbarSelectTitle, filterbarSelect);

        // FILTERING VIA SELECT BAR ONCHANGE //
        filterbarSelect.addEventListener('change', function (e) {
            _content2.default.createContentViaFiltering(type, e.target.value);
        });
    };
    ...
    var sort = function sort() {
        ...
        // CREATE SELECT DROPDOWN ELEMENT(SELECT) WITH CLASSNAME //
        var filterbarSort = _dom2.default.createElementWithClassName('select', 'filterbar__sort'),
            filterbarSortTitle = _dom2.default.createElementWithClassName('span', 'filterbar__sort--title');

        filterbarSortTitle.textContent = "Sort by:";

        var sortOptions = ['Newest', 'Oldest', 'Brand A-Z', 'Brand Z-A'];
        ...
        try {
            for (var _iterator = sortOptions[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                var opt = _step.value;

                var option = _dom2.default.createElement('option');
                option.textContent = option.value = opt;
                _dom2.default.append(filterbarSort, option);
            }
        ...
        var filterFrameLeft = _dom2.default.getElement('content__galery__info__filter-left');
        _dom2.default.append(filterFrameLeft, filterbarSortTitle, filterbarSort);

        // SORTING VIA SELECT BAR ONCHANGE //
        filterbarSort.addEventListener('change', function (e) {
            _content2.default.createContentViaSorting(e.target.value);
        });
    };
...
var searchOffers = function searchOffers(el) {

    var url = 'https://couponmatix.firebaseio.com/v0/items.json';
    var search_results = _dom2.default.getElement('filterbar__searchbar__result'),
        searchbar = _dom2.default.getElement('filterbar__searchbar');
        ...
        if (input_val.length > 0) {
            ...
            _dom2.default.getOffers(url).then(function (result) {
                ...
                for (var prop in offer) {
                    ...
                    try {
                        for (var _iterator = offer[prop][Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                            var sub_prop = _step.value;

                            var re = new RegExp('\\b' + input_val, 'i');
            ...
            }).then(function (offers_found) {

                // REMOVE PREVIOUS SEARCH RESULTS //
                _dom2.default.removeAllChildren(search_results);
                ...
                if (offers_found.length > 0) {
                    var _loop = function _loop(i) {
                        var filterbar_li = _dom2.default.createElementWithClassName('li', 'filterbar__searchbar__result__links'),
                            filterbar_li_a = _dom2.default.createElementWithClassName('a', 'filterbar__searchbar__result__links_a');

                        filterbar_li_a.textContent = offers_found[i].statement + ' ' + offers_found[i].description + ' ';
                        filterbar_li_a.href = '#';

                        filterbar_li_a.addEventListener('click', function (e) {
                            e.preventDefault();
                        ...
                        _dom2.default.append(filterbar_li, filterbar_li_a);
                        _dom2.default.append(search_results, filterbar_li);
                    };

                    // SHOW RESULTS AS LINKS RIGHT BELOW SEARCH BAR //
                    for (var i = 0; i < offers_found.length; i++) {
                        _loop(i);
                    }
                } else {
                    var filterbar_li = _dom2.default.createElementWithClassName('li', 'filterbar__searchbar__result__links');
            ...
            _dom2.default.removeElement(search_results);
            search_results.style.display = 'none';

            // EMPTY CONTENT ELEMENT //
            var content = _dom2.default.getElement('content');
            _dom2.default.removeAllChildren(content);
            var footerEl = _dom2.default.getElement('footer');
            if (footerEl !== null) {
                _dom2.default.removeElement(footerEl);
            }
            _content2.default.createContentMainPage();
        }
    }); // Event listener
};

var showResults = function showResults(offer) {

    var content_galery = document.querySelectorAll('.content__galery');
    for (var index = 0; index < content_galery.length; index++) {
        if (index === 0) _dom2.default.removeAllChildren(content_galery[index]);else _dom2.default.removeElement(content_galery[index]);
    }

    var content_galery_info = _dom2.default.createElementWithClassName('div', 'content__galery__info row__xs-12 row__lg-12'),
        h2 = _dom2.default.createElementWithClassName('h2', 'content__galery__info__title content__galery__info__title--box-shadow');
    h2.textContent = "Search Results";

    _dom2.default.append(content_galery[0], content_galery_info);
    _dom2.default.append(content_galery_info, h2);

    window.removeEventListener('scroll', _dom2.default.handleScroll);

    var content_galery_container = _dom2.default.createElementWithClassName('div', 'content__galery__container');
    _dom2.default.append(content_galery[0], content_galery_container);

    if (offer.length === 0) {
        var para = _dom2.default.createElementWithClassName('p', 'content__galery__container__not-found');
        para.textContent = "Sorry. Offer Not Found!";
        _dom2.default.append(content_galery_container, para);
    } else {
        if (!Array.isArray(offer)) {
            _dom2.default.createContentGaleryOffer(content_galery_container, offer);
        } else {
            // LOOP THROUGH RESPONSE OBJECT (WHICH IS ARRAY NOW, AFTER PARSED FROM JSON) //
            for (var i = 0; i < offer.length; i++) {
                _dom2.default.createContentGaleryOffer(content_galery_container, offer[i], i);
            } //END OF LOOP//
        }
    }
};

exports.default = searchOffers;
...
var header = _dom2.default.createElementWithClassName('div', 'header');
// APPEND HEADER ELEMENT INTO DOM //
_dom2.default.append(document.body, header);

///////////////////////////
// CREATE NAVBAR ELEMENT //
var navbar = _dom2.default.createElementWithClassName('div', 'navbar navbar--margin-bottom row');
// APPEND NAVBAR INTO HEADER //
_dom2.default.append(header, navbar);

//////////////////////////////////
// CREATE NAVBAR--LOGO ELEMENT //
var navbarLogo = _dom2.default.createElementWithClassName('div', 'navbar__logo row__xs-0 row__s-0 row__md-3 row__lg-2'),
    navbarLogoLink = _dom2.default.createElementWithClassName('a', 'narbar__logo__link'),
    navbarLogoLinkImage = _dom2.default.createElementWithClassName('img', 'narbar__logo__link__image');
...
_dom2.default.append(navbar, navbarLogo);
_dom2.default.append(navbarLogo, navbarLogoLink);
_dom2.default.append(navbarLogoLink, navbarLogoLinkImage);

//////////////////////////////////
// CREATE NAVBAR--MENU ELEMENT //
var navbarMenu = _dom2.default.createElementWithClassName('div', 'navbar__menu row row__xs-12 row__s-12 row__md-9 row__lg-10 row--gutter row--align-items');
var navbarMenuLinks = _dom2.default.createElementWithClassName('div', 'navbar__menu__links');
var navbarMenuLinksRow = _dom2.default.createElementWithClassName('div', 'navbar__menu__links--flex row__xs-12 row__s-12 row__m-12 row__lg-12');

// APPEND NAVBAR--MENU INTO NAVBAR //
_dom2.default.append(navbar, navbarMenu);
_dom2.default.append(navbarMenu, navbarMenuLinks);
_dom2.default.append(navbarMenuLinks, navbarMenuLinksRow);
...
for (var attributes in linksArr) {
    var navbarMenuLinksRowA = _dom2.default.createElement('a');
    ...
    _dom2.default.append(navbarMenuLinksRow, navbarMenuLinksRowA);
}

// CREATE MOBILE-LOGO //
var mobileLogoFrame = _dom2.default.createElementWithClassName('div', 'navbar__menu__links__mobileLogo-frame'),
    mobileLogoImage = _dom2.default.createElementWithClassName('img', 'navbar__menu__links__mobileLogo-image');

mobileLogoImage.src = "./images/logo--small.png";

// INSERT LOGO INTO NAVBAR--MENU--LINKS
_dom2.default.append(mobileLogoFrame, mobileLogoImage);
navbarMenuLinksRow.insertBefore(mobileLogoFrame, navbarMenuLinksRow.firstElementChild);

// CREATE HAMBURGER ICON //
var navbarMenuLinksRowHamburger = _dom2.default.createElementWithClassName('a', 'navbar__menu__links__hamburgerIcon');
navbarMenuLinksRowHamburger.innerHTML = "&#9776;";
_dom2.default.append(navbarMenuLinksRow, navbarMenuLinksRowHamburger);

// RETRIEVE HAMBURGER ICON LINK AND MENU //
var hamburgerIcon = document.querySelector('.navbar__menu__links__hamburgerIcon'),
    menu = document.querySelector(".navbar__menu__links"),
    wrapper = document.getElementsByClassName('wrapper');

// HIDE/SHOW MENU LINKS WHEN YOU CLICK ON HAMBURGER MENU //
hamburgerIcon.addEventListener('click', function (event) {
    var wrapperClass = wrapper[0].className;
    var menuFlex = document.querySelector('.navbar__menu__links--flex');
...
var createFooter = function createFooter() {
    var footer = _dom2.default.createElementWithClassName('div', 'footer footer--width');
    ...
    var footerContent = _dom2.default.createElementWithClassName('div', 'footer--content');
    _dom2.default.append(footerEl, footerContent);

    var socialIcons = _dom2.default.createElementWithClassName('div', 'footer__social-icons row');
    _dom2.default.append(footerContent, socialIcons);
    ...
    try {
        for (var _iterator = socialIconsList[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            var imageDetails = _step.value;

            var socialIconsLink = _dom2.default.createElementWithClassName('a', 'footer__social-icons__link'),
                socialIconsLinkImage = _dom2.default.createElementWithClassName('img', 'footer__social-icons__link__image');
            ...
            _dom2.default.append(socialIcons, socialIconsLink);
            _dom2.default.append(socialIconsLink, socialIconsLinkImage);
        }
    } catch (err) {
        _didIteratorError = true;
        _iteratorError = err;
    ...
    var footerCopyright = _dom2.default.createElementWithClassName('div', 'footer__copywrite row'),
        footerCopyrightAuthor = _dom2.default.createElementWithClassName('p', 'footer__copywrite__author'),
        footerCopyrightAuthorLink = _dom2.default.createElementWithClassName('a', 'footer__copywrite__author__link');
    ...
    _dom2.default.append(footerCopyrightAuthor, footerCopyrightAuthorLink);
    _dom2.default.append(footerCopyright, footerCopyrightAuthor);
    _dom2.default.append(footerContent, footerCopyright);
};
...
var templateAds = {
    'medium': [{
        ...
        linkUrl: 'https://www.thebodyshop.com/en-us/login',
        alt: 'Join The Body Show Love Your Body Club'
    }, {
        imgUrl: './images/ad2.jpg',
        linkUrl: 'https://www.breatheright.com/offers/free-sample.html',
        alt: 'Free Breathe Right Sample'
    }, {
        imgUrl: './images/ad3.jpg',
        linkUrl: 'http://coupons.target.com/',
        alt: 'Target Kraft Coupons'
    }, {
        imgUrl: './images/ad4.jpg',
        linkUrl: 'https://www.bk.com/app',
        alt: 'Download BK APP For Coupons'
    }, {
        imgUrl: './images/ad5.jpg',
        linkUrl: 'http://www.hormel.com/Coupons',
        alt: 'Print Hormel Coupons'
    }, {
        imgUrl: './images/ad6.jpg',
        linkUrl: 'http://www.pepsi.com/en-us/d/',
        alt: 'FREE Large Drink via Text Messaage'
    }, {
        imgUrl: './images/ad7.jpg',
        linkUrl: 'https://arbys.com/get-deals',
        alt: 'Sign Up For Arbys Coupons'
    }, {
        imgUrl: './images/ad8.jpg',
        linkUrl: 'https://www.kelloggsfamilyrewards.com/en_US/coupons.html',
        alt: 'Check Out Kellogg’s Family Rewards'
    }, {
        imgUrl: './images/ad9.jpg',
        linkUrl: 'http://coupon.pomwonderful.com/',
        alt: 'Pom Wonderful Coupon'
    }, {
        imgUrl: './images/ad10.jpg',
        linkUrl: 'http://www.publix.com/savings/coupons/digital-coupons',
        alt: 'Publix Super Markets Coupons'
    }, {
        imgUrl: './images/ad11.jpg',
        linkUrl: 'https://www.amazon.com/Prime-Day/b?ie=UTF8&node=13887280011',
        alt: 'Amazon Prime Day Deals'
    }],

    'large': [{
        imgUrl: './images/ad_b1.jpg',
        linkUrl: 'https://www.amazon.com/Prime-Day/b?ie=UTF8&node=13887280011',
        alt: 'Amazon Prime Day Deals'
    }, {
        imgUrl: './images/ad_b2.jpg',
        linkUrl: 'https://www.amazon.com/Prime-Day/b?ie=UTF8&node=13887280011',
        alt: 'Amazon Prime Day Deals'
    }, {
        imgUrl: './images/ad_b3.jpg',
        linkUrl: 'https://www.coupons.com/brands/bic-coupons/',
        alt: 'Available BIC Coupons From Coupons.com'
    }, {
        imgUrl: './images/ad_b4.jpg',
        linkUrl: 'http://www.crayola.com/browse-products/special-offers.aspx',
        alt: 'Special Offers For Crayola Products'
    }, {
        imgUrl: './images/ad_b5.jpg',
        linkUrl: 'https://www.amazon.com/Prime-Day/b?ie=UTF8&node=13887280011',
        alt: 'Amazon Prime Day Deals'
    }, {
        imgUrl: './images/ad_b6.jpg',
        linkUrl: 'https://www.amazon.com/Prime-Day/b?ie=UTF8&node=13887280011',
        alt: 'Amazon Prime Day Deals'
    }]
};

exports.default = templateAds;
...
_filterbar2.default.content();

// GENERATE CONTENT-GALERY INFO & DESCRIPTION & OFFERS
_content2.default.createContentMainPage();

// GENERATE ADS //
_content2.default.ads();

// ADD ACTIVE CLASS TO HOME BUTTON //
var homeLink = document.querySelector('.navbar__menu__links a');
...
window.addEventListener('scroll', function () {
    ...
    var scrolled = window.pageYOffset || document.documentElement.scrollTop || document.body.scrollTop || 0;
    var logo = _dom2.default.getElement('narbar__logo__link__image'),
        navbar = _dom2.default.getElement('navbar'),
        filterbar = _dom2.default.getElement('filterbar--content');
...
window.addEventListener('click', function (e) {
    if (e.target.className !== 'filterbar__searchbar' || e.target.className !== 'filterbar__searchbar__result') {
        _dom2.default.getElement('filterbar__searchbar__result').style.display = 'none';
    }
});
...
var _loop = function _loop(element) {
    ...
    element.name.addEventListener('click', function (event) {
        ...
        _content2.default.createPage(element.type);
        _content2.default.sideAd();

        // REMOVE ACTIVE CLASS FROM OTHER LINKS //
        var navbarLinks = document.querySelectorAll('.navbar__menu__links a');
        ...
        var menu = document.querySelector(".navbar__menu__links"),
